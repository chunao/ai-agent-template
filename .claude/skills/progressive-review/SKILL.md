...
- Codex委任可能性: 高 - 独立した評価タスクで明確な評価基準があり、git diff出力で十分なコンテキスト
...
| **適用シーン** | PR前の最終レビュー | 簡易チェック、CI内レビュー |

## 80点ルール

- **80点以上**: 前進を提案（完璧を求めすぎない）
- **80点未満**: 修正後に再レビュー
